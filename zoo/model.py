...
class User(flask_login.UserMixin, db.Model):
    ...
    bookings = db.relationship(
        "ActivityBooking", back_populates="user", cascade="delete")
...
class Activity(db.Model):
    ...
    schedules = db.relationship("ActivitySchedule", back_populates="activity",
                                order_by="ActivitySchedule.timestamp", cascade="delete")
...
class ActivityType(db.Model):
    ...
    activities = db.relationship(
        "Activity", back_populates="type", cascade="delete")
